...
a) Qual o índice da posição na tabela em que é colocado o último valor da sequência `< 10, 12, 7, 9, 4, 11, 2 >` assumindo que a tabela se encontra inicialmente vazia ?

b) Quais os valores na tabela depois de remover a sequência `< 9, 11 >` seguida da inserção do valor `14` ?
